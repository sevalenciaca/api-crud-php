...
$servidor = "localhost"; $usuario = "root"; $contrasenia = ""; $nombreBaseDatos = "landings";
...
if(isset($_GET["insertar"])){
    ...
    if(($nombre!="")&&($celular!="")&&($email!="")&&($descripcion!="")){
        $sql = mysqli_query($conexionBD,"INSERT INTO customers(nombre,celular,email,descripcion) VALUES('$nombre','$celular','$email','$descripcion') ");
        echo json_encode(["success"=>1]);
    }
    exit();
}
